...
class Reach5Mini():
    ...
    global_serial.device_ids = deviceIDs
...
#     rs.set_position(5, 80)
#     rs.set_position(3, 30)
#    time.sleep(3)
    # rs.set_position(2, 120)
    # time.sleep(2)
    # rs.get_position(3)ssssssssssssssssssssssssssssssssssssssssssssadddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddswswsad
    # rs.set_position(4, 10)
    # time.sleep(3)
    # rs.set_position(2, 20)
    # time.sleep(2)
    # # rs.set_position(3, 30)
    # time.sleep(3)
