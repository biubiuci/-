...
if __name__ == '__main__':
    ...
    rs.set_end_effector_position(5, 100, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 100, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 100, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 100, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 100, 0, 150, 0, 0, 0)

    rs.set_end_effector_position(5, 65, 80, 400, 0, 0, 0)
    rs.set_end_effector_position(5, 65, 80, 400, 0, 0, 0)
    rs.set_end_effector_position(5, 65, 80, 400, 0, 0, 0)
    rs.set_end_effector_position(5, 65, 80, 400, 0, 0, 0)
    rs.set_end_effector_position(5, 65, 80, 400, 0, 0, 0)
    ...
    rs.set_end_effector_position(5, 65, 80, 400, 0, 0, 0)
    rs.set_end_effector_position(5, 65, 80, 400, 0, 0, 0)
    rs.set_end_effector_position(5, 200, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 200, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 200, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 150, 150, 150, 0, 0, 0)      # send position (in mm) to grabber device
    rs.set_end_effector_position(5, 150, 150, 150, 0, 0, 0) 
    rs.set_end_effector_position(5, 150, 150, 150, 0, 0, 0) 
    rs.set_end_effector_position(5, 150, 150, 150, 0, 0, 0) 
    rs.set_end_effector_position(5, 200, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 200, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 200, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, 200, 0, 150, 0, 0, 0)
    rs.set_end_effector_position(5, -100, -25, -200, 3, 4, 5)
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    rs.set_end_effector_position(5, 100, 25, 236, 3, 4, 5) # send position (in mm) to grabber device
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    rs.set_end_effector_position(5, 100, 25, 200, 3, 4, 5) # send position (in mm) to grabber device
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    ...
    rs.set_end_effector_position(5, 100, 25, 236, 3, 4, 5) # send position (in mm) to grabber device
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    rs.set_end_effector_position(5, 80, 25, 236, 3, 4, 5) # send position (in mm) to grabber device
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    ...
    grabber_device_id = rs.deviceIDs[1]
    rs.set_position(grabber_device_id, 90)      # send velocity (in mm/s) to grabber device
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    rs.set_position(grabber_device_id, -90)       # send a different velocity
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    rs.set_velocity(grabber_device_id, 0)       # send a different velocity
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.

    grabber_device_id = rs.deviceIDs[2]
    rs.set_velocity(grabber_device_id, -1)      # send velocity (in mm/s) to grabber device
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    rs.set_velocity(grabber_device_id, 1)       # send a different velocity
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    ...
    grabber_device_id = rs.deviceIDs[3]
    rs.set_velocity(grabber_device_id, -1)      # send velocity (in mm/s) to grabber device
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
    rs.set_velocity(grabber_device_id, 1)       # send a different velocity
    time.sleep(2)       # give it 2 seconds to allow device to move. This is for demonstration purposes only. Not essential.
